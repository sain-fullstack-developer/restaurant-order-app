...
interface OrderListItemsProps {
	...
	handleQuantityChange: (index: number, evt: number, data: {}) => void;
	index: number;
}

const OrderListItem: FC<OrderListItemsProps> = ({
	data,
